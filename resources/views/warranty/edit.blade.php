            ...
            <div class="col-md-9" style="float: none; margin: 0 auto">
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        <form action="{{route('warrantysetup.update',['id'=>$id])}}" method="post">
                            {{csrf_field()}}
                            {{ method_field('PUT') }}
                            <div class="form-group">
                                ...
                                <select style="width: 100%" class="form-control warrant inputs" id="codes" name="codes[]" multiple required>
                                    @foreach(json_decode($details->item_codes) as $datail)
                                    <option value="{{$datail}}" selected>{{$datail}}</option>
                                    @endforeach
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" value="{{$details->labour}}" required max="50" min="0" class="form-control" id="service" name="service">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" value="{{$details->service}}" required max="50" min="0" class="form-control" id="labour" name="labour">
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" required max="50" value="{{$details->parts}}" min="0" class="form-control" id="parts" name="parts">
                                        </div>
