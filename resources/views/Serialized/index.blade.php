                            ...
                            @foreach($grvlines as $grvline)
                                ...
                                ?>">
                                    ...
                                    <td >
                                        ...
                                        <a class="issuecolor linkstyle" href="{{route('serialized.show',['id'=>$grvline->autoindex_id])}}">
                                            <i class="fa fa-eye fa-lg"></i> View
                                        </a>
                                        @if($grvline->status != \App\Grv::SERIALIZED_GRV)
                                        <a class="viewcolor linkstyle" href="{{route('grv.edit',['autoindex_id'=>$grvline->autoindex_id])}}">
